...
class Mahasiswa{
    public:
        ...
        Mahasiswa(string inputNama, string inputNIM, string inputJurusan, double inputIPK){ // Nama fungsi ini harus sama dengan nama Class
...
Tidak punya return type (bahkan void pun tidak)

Dipanggil otomatis, bukan manual
*/