...
// friend sebuah keyword, yang nantinya akan membuat function bisa
// mengakses member public atau non-public(private)
...
class StrengthHero{
    ...
    public:
        ...
        friend bool compare(const IntelHero& hero1, const StrengthHero& hero2); // deklarasi di intel hero
};
...
// bisa menggunakan ini tanpa menjabarkan si fungsi lagi
// kalo kita punya kedua kelas yang mirip mirip
